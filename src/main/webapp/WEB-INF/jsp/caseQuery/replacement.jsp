                ...
                <div class="modal-body">
                    <div class="row">
                        <%--<div class="col-md-6">
                            <div class="form-group">
                                <label>现堪编号</label>
                                <input type="text" class="form-control" placeholder="请输入现堪编号" name="evidenceNo">
                            </div>
                        </div>--%>
                        <div class="col-md-6">
                            <div class="form-group">
    ...
    <div class="row Modular">
        <div class="col-md-6 starBox small-consignment">
            <p class="starP">
                ...
                <span>
                    <%--<input type="text" class="form-control" id="consignmentNo" name="consignmentNo" style="width: 120%;"--%>
                           <%--disabled="disabled" value="${consignatioInfo.consignmentNo}">${consignmentNo}--%>
                      <c:choose>
                       ...
                       <span>
                        <input type="text" class="form-control" id="consignmentNo" name="consignmentNo"
                               style="width: 120%;" value="${consignatioInfo.consignmentNo}">${consignmentNo}
                      </span>
                          </c:otherwise>
                      </c:choose>
                </span>
                <span style="color: #666666; font-size: medium;  font-weight: 400; margin-left: 20px">
        ...
        <div class="col-md-5 starBox">
            <p class="starP" style="margin-left: 70px">
                <i class="fa fa-star star" aria-hidden="true"></i>现勘编号:<span>${xkNo}</span>
                <button class="btn btn-blue" type="button" style="opacity:0;cursor: default;">修改</button>
                <c:choose>
                    <c:when test="${limsCaseInfo.caseStatus eq '01'}">
        ...
        <div class="col-md-6 starBox">
            <p class="starP">
                <i class="fa fa-star star" aria-hidden="true"></i>案件三版本编号:<span>${limsCaseInfo.xkAno}</span>
            </p>
        </div>
        <div class="col-md-5 starBox">
            <p class="starP" style="margin-left: 70px">
                    ...
                    <table class="table table-hover table-bordered bigTable">
                        ...
                        <c:forEach items="${limsPersonInfoList}" var="limsPersonInfo" varStatus="s">
                            <tr>
                                ...
                                <td>${limsPersonInfo.personIdCard}<input type="hidden" name="idCard"
                        ...
                        <c:forEach items="${limsSampleInfoList}" var="sampleInfo" varStatus="s">
                            <tr id="${sampleInfo.sampleId}">
                                ...
                                <td>${sampleInfo.evidenceNo}
                                    <input type="hidden" name="evidenceNo" value="${sampleInfo.evidenceNo}"></td>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn-icon btn-icon-red btn-icon-shanchu-red remove">删除
                                    </button>
...
<script>
    $(function () {
        ...
        var url = "<%=path%>/caseQuery/submitReplacement";
