...
$("#authenticatorTbody").on("click", ".edit", function () {
   ...
   /* //关联在逃人员
    $("#authenticatorTbody").children().each(function () {
        var newOption = '<option linkId="' + $(this).find("input[name='fugitivesCard']").val() + '" value="' + $(this).find("input[name='fugitivesName']").val() + '">' + $(this).find("input[name='fugitivesName']").val() + '</option>'
        $("#addAuthenticatorBig").find('select[name="fugitivesRelation"]').append(newOption)
    })
    $("#addAuthenticatorBig").find('select[name="fugitivesRelation"]').find("option[linkId='" + fugitivesCard + "']").prop("selected", true);
    */
    ...
    if (form.data('bootstrapValidator').isValid()) {
        ...
        if (authenticatorIndex != "") {
            ...
            if (tr.find("input[name='personId']").length) {
                $("#personSampleTbody").find("input[name='linkId'][value='" + tr.find("input[name='personId']").val() + "']").parents("tr")
            } else {
                $("#personSampleTbody").find("input[name='timeId'][value='" + tr.find("input[name='timeId']").val() + "']").parents("tr")
            }
