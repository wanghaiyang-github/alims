	...
	generPageHtml : function(config,enforceInit){
		...
		if(this.isShowCurrPage){
			...
			if(this.isShowTotalPage){
				...
				total_info += this.lang.totalPageBeforeText + '<span class="currPageNum totalPageNum">'+this.total + '</span>' + this.lang.totalPageAfterText;
			}
			if(this.isShowTotalRecords){
				total_info += total_info_splitstr;
				total_info += this.lang.totalRecordsBeforeText + '<span class="currPageNum totalRecordNum">'+this.totalRecords + '</span>' + this.lang.totalRecordsAfterText;
			}
